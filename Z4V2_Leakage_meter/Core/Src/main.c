...
const osThreadAttr_t tsk_Calc_attributes = {
  .name = "tsk_Calc",
  .stack_mem = &tsk_CalcBuffer[0],
  .stack_size = sizeof(tsk_CalcBuffer),
  .cb_mem = &tsk_CalcControlBlock,
  .cb_size = sizeof(tsk_CalcControlBlock),
...
const osThreadAttr_t tsk_Ul_attributes = {
  .name = "tsk_Ul",
  .stack_mem = &tsk_UlBuffer[0],
  .stack_size = sizeof(tsk_UlBuffer),
  .cb_mem = &tsk_UlControlBlock,
  .cb_size = sizeof(tsk_UlControlBlock),
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for tsk_MODBUS */
osThreadId_t tsk_MODBUSHandle;
uint32_t tsk_MODBUSBuffer[ 128 ];
osStaticThreadDef_t tsk_MODBUSControlBlock;
const osThreadAttr_t tsk_MODBUS_attributes = {
  .name = "tsk_MODBUS",
  .stack_mem = &tsk_MODBUSBuffer[0],
  .stack_size = sizeof(tsk_MODBUSBuffer),
  .cb_mem = &tsk_MODBUSControlBlock,
  .cb_size = sizeof(tsk_MODBUSControlBlock),
  .priority = (osPriority_t) osPriorityHigh,
};
/* Definitions for queue_ADC */
osMessageQueueId_t queue_ADCHandle;
uint8_t queue_ADCBuffer[ 8 * sizeof( uint8_t ) ];
osStaticMessageQDef_t queue_ADCControlBlock;
const osMessageQueueAttr_t queue_ADC_attributes = {
  .name = "queue_ADC",
  .cb_mem = &queue_ADCControlBlock,
  .cb_size = sizeof(queue_ADCControlBlock),
  .mq_mem = &queue_ADCBuffer,
  .mq_size = sizeof(queue_ADCBuffer)
};
/* Definitions for queue_USB */
osMessageQueueId_t queue_USBHandle;
uint8_t queue_USBBuffer[ 128 * sizeof( uint16_t ) ];
osStaticMessageQDef_t queue_USBControlBlock;
const osMessageQueueAttr_t queue_USB_attributes = {
  .name = "queue_USB",
  .cb_mem = &queue_USBControlBlock,
...
int main(void)
{
  ...
  queue_ADCHandle = osMessageQueueNew (8, sizeof(uint8_t), &queue_ADC_attributes);

  /* creation of queue_USB */
  queue_USBHandle = osMessageQueueNew (128, sizeof(uint16_t), &queue_USB_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LCD_DB7_Pin|LCD_RS_Pin|LCD_E_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LCD_DB4_Pin|LCD_DB5_Pin|LCD_DB6_Pin|K_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(TP8_GPIO_Port, TP8_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LCD_DB7_Pin LCD_RS_Pin LCD_E_Pin */
  GPIO_InitStruct.Pin = LCD_DB7_Pin|LCD_RS_Pin|LCD_E_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : LCD_DB4_Pin LCD_DB5_Pin LCD_DB6_Pin K_Pin */
  GPIO_InitStruct.Pin = LCD_DB4_Pin|LCD_DB5_Pin|LCD_DB6_Pin|K_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PB_SW1_Pin PB_SW2_Pin DSW_3_Pin DSW_4_Pin
                           GPI_PB15_Pin PB_SW3_Pin PB_SW4_Pin */
  GPIO_InitStruct.Pin = PB_SW1_Pin|PB_SW2_Pin|DSW_3_Pin|DSW_4_Pin
                          |GPI_PB15_Pin|PB_SW3_Pin|PB_SW4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : DSW_1_Pin DSW_2_Pin */
  GPIO_InitStruct.Pin = DSW_1_Pin|DSW_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
